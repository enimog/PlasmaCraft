...
public class EntityCryoBlast extends EntityArrow
{
    ...
    public EntityCryoBlast(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        else
        {
            ...
            {
                worldObj.setBlockState(blockpos, PlasmaCraft.BLOCK_FROZEN_CRYONITE.getDefaultState());
            }
            this.setDead();
        }
    }
