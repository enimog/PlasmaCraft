...
public class EntityPlasma extends EntityArrow
{
    ...
    public EntityPlasma(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    ...
    public EntityPlasma(World worldIn, EntityLivingBase shooter)
    {
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        else
        {
            ...
            // Indestructible blocks have their hardness set to -1
            if (iblockstate.getBlockHardness(worldObj, blockpos) >= 0)
            {
                worldObj.setBlockState(blockpos, Blocks.LAVA.getDefaultState());
            }
            this.setDead();
        }
    }
