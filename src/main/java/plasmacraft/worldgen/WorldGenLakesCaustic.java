...
public class WorldGenLakesCaustic
{
    private final Block block;
    private final Block Edges;

    public WorldGenLakesCaustic(Block blockIn)
    {
        this.block = blockIn;
        this.Edges = Blocks.STONE;
    }
    
    public WorldGenLakesCaustic(Block blockIn, Block egdeIn)
    {
        this.block = blockIn;
        this.Edges = egdeIn;
    }
            ...
            for (int j2 = 0; j2 < 16; ++j2)
            {
                for (int k3 = 0; k3 < 16; ++k3)
                {
                    for (int k4 = 0; k4 < 8; ++k4)
                    {
                        ...
                        {
                            worldIn.setBlockState(position.add(j2, k4, k3), Edges.getDefaultState(), 2);
                        }
                    }
                }
            }
